...
karin::terminal::terminal(QGraphicsWidget *parent)
	...
	m_menuBtn(new karin::button(this)),
	...
	tabGroup(new karin::tab_group(this))
{
	...
	m_menu->setAppearType(karin::popup::Popup_Appear_In_ParentWidget);
	m_menu->setZValue(20);
	m_menu->setParentWidget(this);
	...
	m_watcher->addPath(karin::toolbar::ToolbarDirectory());
...
{
	MMessageBox *messageBox = new MMessageBox("asdasdas", "asdadasdasdasdasdas", this);
	messageBox->setPos(QPointF(0, 0));
